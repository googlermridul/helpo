                  ...
                  <div className="col">
                     <div className="login-box shadow">
                        ...
                        <form onSubmit={handleRegistration}>
                           ...
                           <button type="submit" className="btn-helpo shadow-sm">Submit</button>
                        </form>
                        <hr />
                        <div className="text-center">
                           <p className="text-danger">{error}</p>
                           <button onClick={handleGoogleSignIn} className="btn-helpo google-btn shadow-sm"><img src={googleIcon} alt="" /> Signin With Google</button>
